          ...
          <ScrollView showsVerticalScrollIndicator={false}>
            ...
            <Section title="DANGER ZONE">
              <TouchableOpacity onPress={handleReset} style={styles.resetBtn}>
                <LinearGradient
                  colors={[Colors.accent.red, '#B71C1C']}
...
const styles = StyleSheet.create({
  ...
  qualityText: { color: Colors.text.muted, fontWeight: '700', fontSize: 13 },
  qualityTextActive: { color: Colors.accent.blue },
  resetBtn: { borderRadius: 14, overflow: 'hidden' },
  resetGrad: { paddingVertical: 14, alignItems: 'center' },
  resetText: { color: '#fff', fontWeight: '900', fontSize: 15 },
  closeBtn: {
    marginTop: 16,
    paddingVertical: 14,
    backgroundColor: 'rgba(255,255,255,0.06)',
...
const rowStyles = StyleSheet.create({
  ...
  label: { flex: 1, color: Colors.text.primary, fontWeight: '600', fontSize: 15 },
});
